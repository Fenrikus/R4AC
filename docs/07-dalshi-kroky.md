...
Перед фазою 0 пройти реєстр [`09-dodatkovi-pytannya.md`](09-dodatkovi-pytannya.md) —
вісім питань із нього блокують пілот, зокрема наявність попереднього GPS-моніторингу
та призначення відповідального за розбір подій.
